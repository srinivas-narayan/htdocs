    <?php 
        echo "<br/>Inside index.php<br/>" . __LINE__ ;
    ...
    <p>Welcome to Paediatric Cardiology Training (UK). This website is aimed for those who are involved in 
    	Paediatric Cardiology training in the UK, and includes information for both prospective trainees and current trainees.
    	Please feel free to add comments regarding any improvements or further information that you feel would be helpful.
    </p>
    <ol class="round">
        <li class="one">
